    ...
    <body>
        <div class="container">
            ...
            <div class="section">
                ...
                <div class="endpoint"><strong>POST /upload</strong> - Upload HTML or XML document</div>
            ...
            <div class="section">
                <h2>📖 Quick Start</h2>
                <p>1. Upload HTML or XML documents via <code>/upload</code></p>
...
async def upload_document(file: UploadFile = File(...)):
    """Upload and process HTML or XML document"""
    if not arqa.initialized:
        await arqa.initialize()
    ...
    try:
        # Validate file type - now supports both HTML and XML
        ...
        # Process with ingestor based on file type
